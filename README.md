# Hi, I'm Lucas J. Ustick 👋

🧬 **Bioinformatician · Microbial Ecologist · Postdoctoral Fellow**

I'm a postdoctoral researcher in the **[Bork Group](https://www.embl.org/groups/bork/)** at **EMBL**, working at the intersection of **bioinformatics, microbial ecology, and metagenomics**.
...
**NFixPlanet** is a Python package for running the NFixPlanet annotation and mapping pipelines, designed to investigate the diversity and distribution of nitrogen-fixing microorganisms (*diazotrophs*) across global ecosystems.
...
**Ustick et al. (2026)** · *bioRxiv Preprint*
...
**Ustick et al. (2023)** · *The ISME Journal*

[📄 Read the paper](https://academic.oup.com/ismej/article/17/10/1671/7505846)

---

### 🧪 Metagenomic analysis reveals global-scale patterns of ocean nutrient limitation

**Ustick et al. (2021)** · *Science*

[📄 Read the paper](https://www.science.org/doi/10.1126/science.abe6301)

---

### 🔬 Research Interests

`Bioinformatics` · `Microbial Ecology` · `Metagenomics` · `Microbial Biogeography` · `Nitrogen Fixation` · `Ocean Microbiology`
